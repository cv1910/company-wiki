    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          <h1 className="text-xl sm:text-2xl font-semibold tracking-tight">Wiki</h1>
          {isEditor && (
            <Button onClick={() => setLocation("/wiki/new")} size="sm" className="card-shadow sm:hidden">
              <Plus className="h-4 w-4 mr-1" />
              Neu
            </Button>
          )}
          {isEditor && (
            <Button onClick={() => setLocation("/wiki/new")} className="card-shadow hidden sm:flex">
