...
export function MobileChatHeader({
  ...
  return (
    <div className="flex items-center gap-2 px-2 py-2.5 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 shrink-0">
      <Button 
        variant="ghost" 
        size="icon" 
        onClick={onBack} 
        className="h-9 w-9 shrink-0 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg"
      >
        <ChevronLeft className="h-5 w-5" />
      </Button>
      
      <div className="flex-1 min-w-0">
        <h2 className="font-semibold text-[16px] text-gray-900 dark:text-gray-100 truncate">{displayName}</h2>
      </div>
